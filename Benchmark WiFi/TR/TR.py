## Need to optimize more the code:
## Automatic pycom.nvs_erase_all()
## Increase the size of the transmitted packet to 59 bytes (max for SF12)
...
#From now on predict and correct slope	
	...
	if err>maxerr:
		...
		## sending will be on the next boot when the wifi is on again (if send==1)
	else:
